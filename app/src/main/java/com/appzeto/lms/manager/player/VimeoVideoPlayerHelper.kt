package com.appzeto.lms.manager.player
...
class VimeoVideoPlayerHelper constructor(private val vimeoPlayer: VimeoPlayerView) :
    ...
    private var mPlayerState: com.appzeto.lms.model.PlayerState? = null
    ...
    override fun initPlayerFromState(playerState: com.appzeto.lms.model.PlayerState) {
